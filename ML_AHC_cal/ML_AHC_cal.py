...
vasp_link = '/home/user2/thiho/apps/vasp.5.4.4_wan3/bin'
wannier90_link = '/home/user2/thiho/apps/wannier90-3.1.0'
...
def run_step2(path):
    ...
    if read_checkpoint(path+'/step2',0) == True:
        ...
        # --------> run vasp
        os.system('cd ' + path + '/step2 && srun '+ vasp_link +'/vasp_ncl > stdout && cd .. && cd ..')
        # ------------------
...
def run_band_vasp(path):
    ...
    if read_checkpoint(path+'/band_vasp',0) == True:
        ...
        # --------> run vasp
        os.system('cd ' + path + '/band_vasp && srun '+ vasp_link +'/vasp_ncl > stdout && cd .. && cd ..')
        # ------------------
